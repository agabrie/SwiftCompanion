...
//  SwiftyCompanion
//
//  Created by abduraghmaan GABRIELS on 2019/11/07.
...
class APIConnection{
    ...
    func genTok(completion: @escaping (_ token: String) -> ()){
        ...
        let url = URL(string: "https://api.intra.42.fr/oauth/token?client_id=\(credentials.client_id.rawValue)&client_secret=\(credentials.client_secret.rawValue)&grant_type=client_credentials")!
